                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li><a href="../rotten/add_movie/<?= $m->id; ?>/?title=<?= urlencode($m->title); ?>&year=<?= $m->year; ?>&img=<?= urlencode($m->img); ?>&m_rating=<?= $m->m_rating; ?>&viewed=1">Add To Viewed List</a></li>
